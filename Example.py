...
if __name__ == "__main__":
    ...
    axis = [ax1, ax2, ax3, ax4, ax5, ax7,ax6,ax8]
    methods = ['MaChaMP', 'PELT', 'WBS', 'SMUCE', 'E-Divise', 'BCP','Lepage','Segmentor3IsBack']
    color = ['cornflowerblue', 'darkred', 'darkorange', 'olive', 'gold', 'teal','salmon','steelblue']
